...
public class ThresholdUpdateRequest {
    String device_id;
    ThresholdBody thresholds; // nested object

    public ThresholdUpdateRequest(String device_id, ThresholdLevels.Thresholds t) {
        this.device_id = device_id;
        this.thresholds = new ThresholdBody(t);
    }

    // Inner class that holds the actual threshold values
    public static class ThresholdBody {
        float caution_nh3, alert_nh3;
        float caution_h2s, alert_h2s;
        float caution_dust, alert_dust;

        public ThresholdBody(ThresholdLevels.Thresholds t) {
